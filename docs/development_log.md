...
**تعديل لون الأيقونات في الوضع الغامق عند إغلاق الشريط الجانبي**

- **D:\Alsaada-ERP\Alsaada_ERP_Platform\styles\sidebar.qss**
    - تغيير لون الأيقونات في وضع الإغلاق ليستخدم اللون الثانوي.
- **D:\Alsaada-ERP\Alsaada_ERP_Platform\app\widgets\sidebar.py**
    - إضافة تحديث ديناميكي لألوان الأيقونات عند التوسع والإغلاق.
...
**تصحيح ألوان الشريط الجانبي المصغر في الوضع الغامق**

- **D:\Alsaada-ERP\Alsaada_ERP_Platform\app\core\theme_manager.py**
    - تحديث القيم الافتراضية للون الثانوي في الثيم الغامق ليتطابق مع الهوية البصرية.
...
**توحيد تنسيقات الوضع الفاتح مع الغامق وإظهار الوضع الحالي في دليل المكونات**

- **D:\Alsaada-ERP\Alsaada_ERP_Platform\app\core\theme_manager.py**
    - جعل لوحة ألوان الوضع الفاتح نسخة من الوضع الغامق مؤقتًا.
- **D:\Alsaada-ERP\Alsaada_ERP_Platform\app\modules\component_guide\view.py**
    - عرض تسمية في الصفحة توضح الوضع النشط حاليًا.
...
- **D:\Alsaada-ERP\Alsaada_ERP_Platform\styles\sidebar.qss**
    - إزالة تدرجات الخلفية للحالة Hover والزر النشط لإظهار ظل خفيف فقط.
- **D:\Alsaada-ERP\Alsaada_ERP_Platform\app\widgets\sidebar.py**
    - تطبيق تأثير DropShadow على الأزرار عند المرور والتفعيل في الحالتين المغلقة والمفتوحة.
...
**تبسيط تأثير الانتقال في الشريط الجانبي**

- **D:\Alsaada-ERP\Alsaada_ERP_Platform\app\widgets\sidebar.py**
    - إزالة تأثير الظل وإضافة خاصية `hovered` لتكبير الخط وتوسيط النص عند المرور والاختيار.
- **D:\Alsaada-ERP\Alsaada_ERP_Platform\styles\sidebar.qss**
    - إضافة قواعد `hovered` و `active` لزيادة حجم الخط وتوسيط الأيقونة والنص.
...
- **D:\\Alsaada-ERP\\Alsaada_ERP_Platform\\app\\core\\company_info.py**
    - إضافة نموذج بيانات مبسط لمعلومات الشركة.
- **D:\\Alsaada-ERP\\Alsaada_ERP_Platform\\app\\widgets\\header.py**
    - تحديث الهيكل لإظهار شعار الشركة واسمها ومعلومات الاتصال من النموذج.
    - تطبيق تأثير الظل وإطار للشعار والهيدر.
- **D:\\Alsaada-ERP\\Alsaada_ERP_Platform\\styles\\header.qss**
    - تعديل التنسيقات لزيادة ارتفاع الهيدر وتنسيق حاوية الشعار.
